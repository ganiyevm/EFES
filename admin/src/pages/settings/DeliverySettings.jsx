                ...
                <div className="card">
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                        ...
                        <div className="form-group">
                            ...
                            <div style={{ fontSize: 11, color: 'var(--text-secondary)', marginTop: 4 }}>0 = yoqilmagan</div>
                        </div>
                        <div className="form-group">
                        ...
                        <div className="form-group">
                            ...
                            <div style={{ fontSize: 11, color: 'var(--text-secondary)', marginTop: 4 }}>Har buyurtmadan beriladigan bonus</div>
                        </div>
                        <div className="form-group">
                            ...
                            <div style={{ fontSize: 11, color: 'var(--text-secondary)', marginTop: 4 }}>Buyurtma summasidan qancha bonus ishlatish mumkin</div>
                        </div>

                        <div style={{ gridColumn: 'span 2' }}>
                            <label style={{ display: 'flex', alignItems: 'center', gap: 10, cursor: 'pointer', padding: '14px 16px', background: 'var(--bg-secondary)', borderRadius: 10, border: '1px solid var(--border)' }}>
                                ...
                                <div>
                                    ...
                                    <div style={{ fontSize: 12, color: 'var(--text-secondary)', marginTop: 2 }}>Buyurtmalarni qabul qilishni yoq/yoq qilish</div>
                                </div>
                            </label>
                        </div>
                    </div>
