...
const STATUS_META = {
    ...
    preparing:        { color: '#8b5cf6', label: 'Tayyorlanmoqda' },
    ready:            { color: '#1abc9c', label: 'Tayyor' },
    on_the_way:       { color: '#f59e0b', label: "Yo'lda" },
...
export default function Dashboard() {
    ...
    const payPie = paymentStats.map(p => ({
        name:  p._id === 'click' ? 'Click' : p._id === 'payme' ? 'Payme' : p._id === 'cash' ? 'Naqd' : p._id,
        value: p.count,
        total: p.total,
    }));
    ...
    const adminName = localStorage.getItem('admin_fullname') || localStorage.getItem('admin_username') || 'Admin';
    ...
    return (
        <div className="bi-dash">
            ...
            <div className="bi-kpi-row">
                <KpiCard index={0} label="Bugungi buyurtmalar"
            ...
            <div className="bi-bottom-row">
                <div className="bi-card">
                    <div className="bi-card__head">
                        ...
                        <a href="/admin/orders" style={{ fontSize: 12, color: '#3b82f6' }}>Barchasi →</a>
                    </div>
